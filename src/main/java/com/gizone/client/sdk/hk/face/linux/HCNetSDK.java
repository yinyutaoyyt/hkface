package com.gizone.client.sdk.hk.face.linux;
...
//SDK接口说明,HCNetSDK.dll StdCallLibrary
public interface HCNetSDK extends Library {

//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(System.getProperty("user.dir") + "\\gizone-client\\src\\main\\resources\\lib\\hk\\HCNetSDK.dll", HCNetSDK.class);
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("C:\\develop\\java\\work\\gizone_micro_service\\gizone-micro-server\\gizone-client\\target\\classes\\"+"lib\\hk\\HCNetSDK.dll", HCNetSDK.class);
    /***宏定义***/
    //常量
